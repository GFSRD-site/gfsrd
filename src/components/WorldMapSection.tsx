...
import journalCover from "@/assets/journal-cover.jpeg";
...
function IndiaMap() {
  ...
  return (
    <div className="relative w-full flex flex-col lg:flex-row gap-2" style={{ height: "380px" }}>
...
function JournalCard() {
  return (
    <motion.div
      ...
      className="bg-card rounded-2xl border border-border/50 shadow-card overflow-hidden flex flex-col self-start mt-20"
    >
...
export function WorldMapSection() {
  ...
  return (
    <section className="py-10 lg:py-32 bg-secondary/20 overflow-hidden">
